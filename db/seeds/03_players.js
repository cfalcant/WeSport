  ...
  return knex('players').del()
    .then(function() {
      ...
      return knex('players').insert([
        ...
        { first_name: 'Rajon', last_name: 'Rondo', team_id: 5, jersey: 9, position: 'PG', points: 10.5, steals: 1.8, assists: 8.4, blocks: 0.1 },
        { first_name: 'Jrue', last_name: 'Holiday', team_id: 5, jersey: 11, position: 'PG', points: 14.7, steals: 1.5, assists: 6.2, blocks: 0.4 },
        { first_name: 'Ian', last_name: 'Clark', team_id: 5, jersey: 2, position: 'SG', points: 4.7, steals: 0.4, assists: 1.0, blocks: 0.1 },
      ]);
    });
};